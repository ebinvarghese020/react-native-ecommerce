    ...
    return (
        <View style={style.container}>
            ...
            <View style={style.box}>
                        ...
                        <Review name={'Philip Fernandus'} body={'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industrys standard dummy text ever since the 1500s.'}/>
                        <Footer/>
                </View>
                <ProductScroll />
                <AddToCart />
